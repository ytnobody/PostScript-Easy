...
# Examples for PostScript::Easy module
# Matthew Newton
# 09 November 2003
# Satoshi Azuma
# 04 June 2014
...
$ps = new PostScript::Easy(xsize => 100,
                                ysize => 100,
                                colour => 1,
                                eps => 1,
                                reencode => undef);
...
$ps = new PostScript::Easy(papersize => "a4",
                             units => "mm",
                             colour => 1,
                             eps => 0,
                             reencode => undef);
...
$directeps->rotate(20);
$directeps->translate(-50, -50);
$eps = new PostScript::Easy(eps => 1, xsize => 100, ysize => 100);
